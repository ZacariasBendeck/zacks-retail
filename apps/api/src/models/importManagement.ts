...
export type ImportShipmentReportKey =
  ...
  | 'ap-handoff';
export type ImportShipmentReportNumberFormat = 'money' | 'integer' | 'decimal2' | 'date';

export interface ImportMoneyInput {
  sourceAmount: number;
...
export interface CreateImportShipmentInput {
...
export interface CreateImportSupplierInvoiceInput extends ImportMoneyInput {
...
export interface UpdateImportSupplierInvoiceInput extends CreateImportSupplierInvoiceInput {}

export interface CreateImportInvoiceLineInput extends Partial<ImportMoneyInput> {
  skuId?: string | null;
...
export interface UpdateImportInvoiceLineInput extends CreateImportInvoiceLineInput {}

export interface CreateImportChargeInput extends ImportMoneyInput {
...
export interface UpdateImportChargeInput extends CreateImportChargeInput {}

export interface CreateImportContainerInput {
...
export interface UpdateImportContainerInput {
  containerNumber?: string | null;
  containerType?: ImportContainerType;
  sealNumber?: string | null;
  cargoGroup?: string | null;
...
export interface CreateGoodsInTransitRecordInput {
...
export interface UpdateGoodsInTransitRecordInput {
  containerId?: string | null;
  shipmentLineId?: string | null;
  status?: GoodsInTransitStatus;
  ownershipTransferAt?: string | null;
...
export interface CreateGoodsInTransitForShipmentInput {
  containerId?: string | null;
  status?: GoodsInTransitStatus;
  ownershipTransferAt?: string | null;
  expectedReceiptAt?: string | null;
...
export interface AddImportShipmentLineInput {
  purchaseOrderLineId: string;
  containerId?: string | null;
...
export interface UpdateImportShipmentLineInput {
  containerId?: string | null;
  expectedQuantity?: number | null;
  estimatedLandedUnitCostHnl?: number | null;
  status?: ImportShipmentLineStatus;
...
export interface MatchImportShipmentLineInvoiceInput {
  invoiceLineId?: string | null;
}

export interface ApproveImportShipmentLineInvoiceMatchInput {
  approved: boolean;
  approvedBy?: string | null;
  reason?: string | null;
}

export interface ApplyImportInvoiceMatchSuggestionsInput {
...
export interface UpdateImportShipmentStatusInput {
  status: ImportShipmentStatus;
  auditReason?: string | null;
  changedBy?: string | null;
}

export interface AllocateImportLandedCostInput {
  markupFactor?: number | null;
}

export interface UpdateImportSuggestedPriceStatusInput {
  approvalStatus: ImportSuggestedPriceApprovalStatus;
  changedBy?: string | null;
}

export interface MarkImportPayablesSentInput {
  apReference?: string | null;
  changedBy?: string | null;
}

export interface MarkImportPayablePaidInput {
  paymentReference?: string | null;
  paidAt?: string | null;
  changedBy?: string | null;
}

export interface VoidImportPayableInput {
  reason: string;
  changedBy?: string | null;
}

export interface ReceiveImportShipmentInput {
...
export interface LinkImportInvoiceLineToPoInput {
  purchaseOrderLineId?: string | null;
}

export interface LinkImportInvoiceLineToSkuInput {
  skuId?: string | null;
  skuCode?: string | null;
}

export interface CreateImportPurchaseOrderDraftInput {
  vendorCode: string;
...
export interface ImportShipmentReportColumn {
  key: string;
  header: string;
  width?: number;
  numFmt?: ImportShipmentReportNumberFormat;
}

export interface ImportShipmentReport {
...
export interface ImportWorkbookPreview {
  ...
  fileName: string;
  shipment: CreateImportShipmentInput;
