...
const ENGLISH_TO_SPANISH: Record<string, Record<string, string[]>> = {
  ...
  'categories': {
    ...
    'sandal platform': ['sandalia plataforma'],
    'boot tall': ['bota alta'],
    'boot ankle': ['bota corta'],
    'boot casual': ['bota casual'],
    'sneaker': ['sneaker'],
    'flat ballet': ['flat/ballerina'],
    'flat loafer': ['flat loafer'],
    'mule': ['mule'],
    'wedge': ['wedge'],
    'espadrille': ['espadrille'],
    'oxford': ['oxford/derby'],
    'comfort casual': ['comfort casual'],
    'comfort walking': ['comfort walking'],
    'comfort orthopedic': ['comfort ortopedico'],
    'slipper': ['pantufla'],
    'rain boot': ['bota lluvia'],
    'platform': ['plataforma'],
    'clog': ['zueco'],
    'slide': ['slide/chancla'],
  },
