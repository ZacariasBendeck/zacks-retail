import type { CommitTransferRunResult, TransferPreviewCell, TransferPreviewException } from './transferRuns'
...
export interface CreateBalancingTransferRunV2Payload {
...
export interface BalancingTransferDecisionContextV2 {
  decisionPass:
    | 'SERVICE_RESCUE'
    | 'CURVE_REPAIR'
    | 'COVERAGE_REBALANCE'
...
export interface BalancingTransferPreviewLineV2 {
  ...
  decisionContext: BalancingTransferDecisionContextV2
}
...
export interface BalancingTransferPreviewSummaryV2 {
  ...
  passBreakdown: Array<{
    decisionPass: BalancingTransferDecisionContextV2['decisionPass']
    transferCount: number
    totalUnits: number
  }>
}
